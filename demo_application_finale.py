...
def main():
    ...
    print("   → Maintenant : Adaptateur PyQt5 ↔ CustomTkinter fonctionnel")
    ...
    print("✅ Adaptateur PyQt5           : 100% opérationnel")
    ...
    print("-"*50)
    print("• Fenêtre principale PyQt5 native (plus rapide)")
    print("• Adaptateur transparent PyQt5 ↔ CustomTkinter")
    ...
    print("⚡  Plus performante - Interface PyQt5 native rapide")
    ...
    print("🔗  Intégrée - PyQt5 + CustomTkinter parfaitement compatibles")
    print("")
