# -*- coding: utf-8 -*-
"""
Gestionnaire d'événements centralisé pour la synchronisation entre fenêtres
"""
...
class EventManager(QObject):
    """Gestionnaire d'événements centralisé pour synchroniser les données entre fenêtres"""
    ...
    def __init__(self):
        ...
        self.logger.info("Gestionnaire d'événements initialisé")
