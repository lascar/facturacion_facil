...
class TestGUIAbstraction:
    ...
    def test_framework_loading(self):
        ...
        # Test PyQt5 (framework unique après migration)
        print("\n   1️⃣ Test PyQt5")
        set_gui_framework('pyqt5')
        manager = get_gui_manager()

        assert manager.get_current_framework() == 'pyqt5'
        # Note: Après migration vers PyQt5 uniquement, pas de factory abstraite
        print(f"     ✅ PyQt5 chargé: Framework {manager.get_current_framework()}")

        # Test PyQt5 (framework unique après migration)
        print("\n   2️⃣ Test PyQt5 (framework unique)")
